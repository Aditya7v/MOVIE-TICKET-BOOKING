...
public partial class AdminLogin : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("select * from AdminRegistration where USERNAME =@USERNAME and PASSWORD=@PASSWORD", con);
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            Response.Redirect("AdminBookingInformation.aspx");
        }
        else
        {
